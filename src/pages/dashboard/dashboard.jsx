...
const Dashboard = () => {
  ...
  const handleSelectCentralPot = async (selectedIndex) => {
    ...
    updatedPlants[selectedIndex] = plantCurrentlyInCenter
      ? { ...plantCurrentlyInCenter }
      : null;
  ...
  return (
    <div className="dashboard">
      ...
      {isLoading ? (
        <div className="loader-plant-wrapper">
          <LoaderPlant />
        </div>
      ) : (
        <>
          <div className="carousel-controls">
            <button
              onClick={() =>
                setCurrentGroupStart((prev) => Math.max(prev - 3, 0))
              }
          ...
          <div className="pots-container">
            {plants
              .slice(currentGroupStart, currentGroupStart + 3)
              .map((plantData, index) => {
